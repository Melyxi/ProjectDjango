...
urlpatterns = [
    ...
    path('orders/read/<int:pk>', adminapp.orders_list, name='admin_orders'),

    path('orders/status/<pk>/', adminapp.order_status, name='order_status'),
    path('orders/recover/<pk>/', adminapp.order_recover, name='order_recover'),
