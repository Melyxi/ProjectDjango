...
class OrderItemsUpdate(UpdateView):
    ...
    def get_success_url(self):
        return reverse('ordersapp:order_update', kwargs={'pk': self.kwargs['pk']})
    ...
    def form_valid(self, form):
        ...
        print(orderitems.is_valid(), 'валидность')
        self.object = form.save()
        if orderitems.is_valid():
            orderitems.instance = self.object
            print('save')
            ...
            #orderitems.clean()
            #orderitems.instance = self.object
            #return HttpResponseRedirect(reverse('ordersapp:order_update',  kwargs = {'pk': self.object.id}))
...
def get_product_quantity(request, pk):
    if request.is_ajax():
